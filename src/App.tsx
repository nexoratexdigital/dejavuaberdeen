...
const LOGO_URL = "https://i.postimg.cc/JD3LsLqF/New233.png";
...
const Logo: React.FC<{ className?: string; style?: React.CSSProperties; isNavbar?: boolean }> = ({ className, style, isNavbar }) => {
  const [error, setError] = useState(false);

  if (error) {
    return (
      <div 
        className={`flex items-center justify-center font-black tracking-[0.4em] text-white uppercase select-none ${className}`} 
        style={{ 
          ...style,
          fontSize: isNavbar ? '12px' : 'clamp(1.2rem, 6vw, 3rem)',
          lineHeight: '1',
          letterSpacing: isNavbar ? '0.3em' : '0.5em'
        }}
      >
        Dejavu
      </div>
    ...
    <header className="relative min-h-[100dvh] w-full flex items-center justify-center overflow-hidden py-32">
      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center text-center px-6 gap-8 md:gap-10">
        ...
        <div className="flex flex-col items-center animate-fade-in delay-500 w-full justify-center mt-6 md:mt-12">
          <div className="flex flex-row gap-4 md:gap-12 justify-center items-center">
            <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="px-6 md:px-10 py-4 text-white text-[9px] font-bold tracking-[0.3em] hover:bg-white hover:text-black transition-all duration-500 uppercase">Book A Booth</a>
            <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer" className="px-6 md:px-10 py-4 text-white text-[9px] font-bold tracking-[0.3em] hover:bg-white hover:text-black transition-all duration-500 uppercase">Join Guestlist</a>
          </div>
        </div>
    ...
    <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
       ...
       <div className="max-w-2xl">
         ...
         <div className="flex flex-row justify-center gap-4 md:gap-8">
           <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="px-6 md:px-10 py-4.5 text-white text-[9px] font-bold tracking-[0.3em] hover:bg-white hover:text-black transition-all duration-500 uppercase">Plan Your Night</a>
           <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="px-6 md:px-10 py-4.5 text-white text-[9px] font-bold tracking-[0.3em] hover:bg-white hover:text-black transition-all duration-500 uppercase">Talk to the team</a>
         </div>
       </div>
    </div>
  </section>
  ...
  <footer className="bg-neutral-950 border-t border-neutral-900 py-32 px-6">
    <div className="max-w-7xl mx-auto text-center space-y-20">
      ...
      <div className="flex flex-col items-center gap-12">
        <div className="flex flex-wrap justify-center gap-6 md:gap-16 text-[9px] md:text-[10px] text-neutral-500 tracking-[0.2em] md:tracking-[0.4em] font-bold uppercase">
          <a 
            href={INSTAGRAM_URL} 
            target="_blank" 
        ...
        <>
          ...
          <section className="py-48 px-6 bg-neutral-950 text-center relative overflow-hidden" id="contact">
            ...
            <div className="relative z-10 space-y-12">
              ...
              <div className="flex flex-row justify-center gap-4 md:gap-10 pt-8">
                 <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer" className="px-6 md:px-12 py-5 text-white text-[9px] font-black tracking-[0.4em] hover:bg-white hover:text-black transition-all duration-500 uppercase">Join Guestlist</a>
                 <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="px-6 md:px-12 py-5 text-white text-[9px] font-black tracking-[0.4em] hover:bg-white hover:text-black transition-all duration-500 uppercase">Book Booth</a>
              </div>
            </div>
          </section>
        </>
